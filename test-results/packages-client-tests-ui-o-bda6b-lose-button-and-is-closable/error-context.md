...
- Name: packages/client/tests/ui-overlay.spec.ts >> UI Overlay Fixes >> 7: help overlay has visible × close button and is closable
- Location: packages/client/tests/ui-overlay.spec.ts:178:3
