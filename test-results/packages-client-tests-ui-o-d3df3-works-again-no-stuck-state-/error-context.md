...
- Name: packages/client/tests/ui-overlay.spec.ts >> UI Overlay Fixes >> 9: after game-over, create room works again (no stuck state)
- Location: packages/client/tests/ui-overlay.spec.ts:346:3
