...
- Name: packages/client/tests/ui-overlay.spec.ts >> UI Overlay Fixes >> 5: special event toast appears at game start
- Location: packages/client/tests/ui-overlay.spec.ts:238:3
