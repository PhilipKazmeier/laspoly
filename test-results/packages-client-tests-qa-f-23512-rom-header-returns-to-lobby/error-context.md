...
- Name: packages/client/tests/qa-full-game.spec.ts >> QA Full-Game Playthrough >> leave room from header returns to lobby
- Location: packages/client/tests/qa-full-game.spec.ts:862:3
