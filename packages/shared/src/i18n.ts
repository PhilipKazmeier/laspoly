...
const de: Catalogue = {
  ...
  rentModMonopoly: "→ Grundmiete verdoppelt: kompletter Straßenzug.",
  rentModRecession: "→ Miete halbiert: Rezession.",
  rentModParty: "→ Miete verdoppelt: Straßenfest in diesem Viertel.",
  rentModCircus: "→ Miete verdoppelt: Der Zirkus ist in der Stadt.",
  rentModPowerOutage: "→ Keine Miete: Stromausfall bei den Bahnhöfen.",
...
const en: Catalogue = {
  ...
  rentModMonopoly: "→ Base rent doubled: full colour group.",
  rentModRecession: "→ Rent halved: recession.",
  rentModParty: "→ Rent doubled: street party in this district.",
  rentModCircus: "→ Rent doubled: the circus is in town.",
  rentModPowerOutage: "→ No rent: power outage at the stations.",
